            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        <h2>LS Store</h2>
                        <p>Loja Virtual inexistente Para Estudos</p>
                        <div class="footer-social">
                            <a href=https://www.facebook.com/lailson.sousa" target="_blank"><i class="fa fa-facebook"></i></a>
                            <a href="https://www.youtube.com/channel/UCYnwGUB1k5AngXz6TYFDjZQ?view_as=subscriber" target="_blank"><i class="fa fa-youtube"></i></a>
                        </div>
                    </div>
                </div>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; Lailson Sousa. <a href="https://github.com/45lailson/ecommece" target="_blank">github.com/45lailson/</a></p>
                    </div>
                </div>
